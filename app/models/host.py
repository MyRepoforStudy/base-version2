...
class Host(TimestampMixin, Base):
    ...
    root_disk_total_gb: Mapped[float | None] = mapped_column(Float)
    root_disk_used_gb: Mapped[float | None] = mapped_column(Float)
    root_disk_used_pct: Mapped[float | None] = mapped_column(Float)
    disk_max_used_pct: Mapped[float | None] = mapped_column(Float)
    disk_max_mount: Mapped[str | None] = mapped_column(String(255))
